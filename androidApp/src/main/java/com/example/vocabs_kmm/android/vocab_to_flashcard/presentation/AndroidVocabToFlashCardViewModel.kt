...
@HiltViewModel
class AndroidVocabToFlashCardViewModel @Inject constructor(private val vocabToPhrase: VocabToPhrase, private val saveAsFlashcard: SaveAsFlashcard): ViewModel() {

    private val viewModel by lazy {
        VocabToFlashcardViewModel(coroutineScope = viewModelScope, vocabToPhrase = vocabToPhrase, saveAsFlashcard = saveAsFlashcard)
    }
